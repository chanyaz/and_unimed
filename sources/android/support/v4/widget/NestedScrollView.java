...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild2, NestedScrollingParent, ScrollingView {
    ...
    public void d(int i) {
        if (getChildCount() > 0) {
            ...
            this.c.fling(getScrollX(), getScrollY(), 0, i, 0, 0, Integer.MIN_VALUE, MoPubClientPositioning.NO_REPEAT, 0, 0);
            this.u = getScrollY();
            ViewCompat.d(this);
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.d != null) {
            ...
            if (!this.d.isFinished()) {
                ...
                this.d.setSize(paddingLeft, height);
            ...
            if (!this.e.isFinished()) {
                ...
                width = getWidth();
                min = getHeight();
                paddingLeft = Math.max(getScrollRange(), scrollY) + min;
                if (VERSION.SDK_INT < 21 || getClipToPadding()) {
    ...
    protected void onScrollChanged(int i, int i2, int i3, int i4) {
        ...
        if (this.B != null) {
            this.B.onScrollChange(this, i, i2, i3, i4);
        }
    }
            ...
            case 2:
                ...
                if (findPointerIndex != -1) {
                    ...
                    if (this.j) {
                        ...
                        if (a(0, i, 0, getScrollY(), 0, y, 0, 0, true) && !hasNestedScrollingParent(0)) {
                            this.k.clear();
                        }
                        int scrollY2 = getScrollY() - scrollY;
                        if (!dispatchNestedScroll(0, scrollY2, 0, i - scrollY2, this.r, 0)) {
                            if (obj != null) {
                                g();
                                actionMasked = scrollY + i;
                                if (actionMasked < 0) {
                                    r.a(this.d, ((float) i) / ((float) getHeight()), motionEvent.getX(findPointerIndex) / ((float) getWidth()));
                                    if (!this.e.isFinished()) {
                                        this.e.onRelease();
                                    }
                                } else if (actionMasked > y) {
                                    r.a(this.e, ((float) i) / ((float) getHeight()), 1.0f - (motionEvent.getX(findPointerIndex) / ((float) getWidth())));
                                    if (!this.d.isFinished()) {
                                        this.d.onRelease();
                                    }
                                }
