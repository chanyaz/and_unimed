...
public class g extends e {
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, a aVar, Resources resources, int i) {
        if (!a()) {
            return super.createFromFontFamilyFilesResourceEntry(context, aVar, resources, i);
        }
        Object b = b();
        b[] a = aVar.a();
        int length = a.length;
        ...
        while (i2 < length) {
            b bVar = a[i2];
            if (a(context, b, bVar.a(), 0, bVar.b(), bVar.c() ? 1 : 0)) {
                i2++;
            } else {
                c(b);
                return null;
    ...
    public Typeface createFromFontInfo(Context context, @Nullable CancellationSignal cancellationSignal, @NonNull android.support.v4.provider.b[] bVarArr, int i) {
        ...
        if (a()) {
            Map a = FontsContractCompat.a(context, bVarArr, cancellationSignal);
            Object b = b();
            Object obj = null;
            ...
            while (i2 < length) {
                Object obj2;
                android.support.v4.provider.b bVar = bVarArr[i2];
            ...
            if (obj != null) {
                return !b(b) ? null : Typeface.create(a(b), i);
            } else {
                c(b);
                return null;
            }
        }
        android.support.v4.provider.b a2 = a(bVarArr, i);
        try {
