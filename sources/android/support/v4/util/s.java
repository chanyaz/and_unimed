...
public class s<K, V> {
    ...
    public void a(s<? extends K, ? extends V> sVar) {
        int i = 0;
        int i2 = sVar.h;
        a(this.h + i2);
        if (this.h != 0) {
            while (i < i2) {
                put(sVar.b(i), sVar.c(i));
                i++;
            }
        } else if (i2 > 0) {
            System.arraycopy(sVar.f, 0, this.f, 0, i2);
            System.arraycopy(sVar.g, 0, this.g, 0, i2 << 1);
            this.h = i2;
        }
    }
        ...
        if (obj instanceof s) {
            ...
            while (i < this.h) {
                try {
                    ...
                    obj2 = sVar.get(b);
                    if (c == null) {
                        if (obj2 != null || !sVar.containsKey(b)) {
                            return false;
                        }
