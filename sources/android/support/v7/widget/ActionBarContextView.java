...
public class ActionBarContextView extends a {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        ...
        db a = db.a(context, attributeSet, k.ActionMode, i, 0);
        ViewCompat.a((View) this, a.a(k.ActionMode_background));
    ...
    public void a(final ActionMode actionMode) {
        ...
        this.i.findViewById(g.action_mode_close_button).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                actionMode.c();
            }
        });
        MenuBuilder menuBuilder = (MenuBuilder) actionMode.b();
        if (this.d != null) {
            this.d.e();
        }
