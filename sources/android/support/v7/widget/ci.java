...
class ci extends Drawable {
    ...
    ci(ColorStateList colorStateList, float f) {
        this.a = f;
        this.b = new Paint(5);
        b(colorStateList);
        this.c = new RectF();
    ...
    private void a(Rect rect) {
        ...
        this.d.set(rect);
        if (this.f) {
            float a = RoundRectDrawableWithShadow.a(this.e, this.a, this.g);
            this.d.inset((int) Math.ceil((double) RoundRectDrawableWithShadow.b(this.e, this.a, this.g)), (int) Math.ceil((double) a));
            this.c.set(this.d);
        }
    }
