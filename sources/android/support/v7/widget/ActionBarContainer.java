...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        ViewCompat.a((View) this, VERSION.SDK_INT >= 21 ? new d(this) : new c(this));
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.h != null) {
            ...
            if (this.g != null && this.g.getVisibility() != 8 && mode != 1073741824) {
                ...
                setMeasuredDimension(getMeasuredWidth(), Math.min(b + b(this.g), mode == Integer.MIN_VALUE ? MeasureSpec.getSize(i2) : MoPubClientPositioning.NO_REPEAT));
            }
        }
    }
    ...
    public void setTabContainer(cl clVar) {
        if (this.g != null) {
            removeView(this.g);
        }
        this.g = clVar;
