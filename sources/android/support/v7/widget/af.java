...
class af {
    ...
    void a(AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = this.l.obtainStyledAttributes(attributeSet, k.AppCompatTextView, i, 0);
        if (obtainStyledAttributes.hasValue(k.AppCompatTextView_autoSizeTextType)) {
            this.c = obtainStyledAttributes.getInt(k.AppCompatTextView_autoSizeTextType, 0);
        }
        float dimension = obtainStyledAttributes.hasValue(k.AppCompatTextView_autoSizeStepGranularity) ? obtainStyledAttributes.getDimension(k.AppCompatTextView_autoSizeStepGranularity, -1.0f) : -1.0f;
        float dimension2 = obtainStyledAttributes.hasValue(k.AppCompatTextView_autoSizeMinTextSize) ? obtainStyledAttributes.getDimension(k.AppCompatTextView_autoSizeMinTextSize, -1.0f) : -1.0f;
        float dimension3 = obtainStyledAttributes.hasValue(k.AppCompatTextView_autoSizeMaxTextSize) ? obtainStyledAttributes.getDimension(k.AppCompatTextView_autoSizeMaxTextSize, -1.0f) : -1.0f;
        if (obtainStyledAttributes.hasValue(k.AppCompatTextView_autoSizePresetSizes)) {
            int resourceId = obtainStyledAttributes.getResourceId(k.AppCompatTextView_autoSizePresetSizes, 0);
            if (resourceId > 0) {
