...
public final class l implements SupportMenuItem {
    ...
    l(MenuBuilder menuBuilder, int i, int i2, int i3, int i4, CharSequence charSequence, int i5) {
        this.a = menuBuilder;
        this.b = i2;
        this.c = i;
        this.d = i3;
    ...
    public boolean expandActionView() {
        return !m() ? false : (this.C == null || this.C.onMenuItemActionExpand(this)) ? this.a.c(this) : false;
    }
    ...
    public Drawable getIcon() {
        ...
        Drawable b = b.b(this.a.e(), this.n);
        this.n = 0;
        this.m = b;
        return a(b);
    }
    ...
    public SupportMenuItem setSupportActionProvider(ActionProvider actionProvider) {
        ...
        this.a.a(true);
        if (this.B != null) {
            this.B.a(new VisibilityListener() {
