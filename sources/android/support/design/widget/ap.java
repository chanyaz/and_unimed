...
class ap {
    ...
    static void a(View view, float f) {
        ...
        stateListAnimator.addState(new int[]{16842766, c.state_collapsible, -c.state_collapsed}, ObjectAnimator.ofFloat(view, "elevation", new float[]{0.0f}).setDuration((long) integer));
