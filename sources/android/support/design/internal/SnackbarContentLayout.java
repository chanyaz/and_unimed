...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        this.c = obtainStyledAttributes.getDimensionPixelSize(l.SnackbarLayout_android_maxWidth, -1);
        this.d = obtainStyledAttributes.getDimensionPixelSize(l.SnackbarLayout_maxActionInlineWidth, -1);
        obtainStyledAttributes.recycle();
    }

    private static void a(View view, int i, int i2) {
        if (ViewCompat.t(view)) {
            ViewCompat.b(view, ViewCompat.h(view), i, ViewCompat.i(view), i2);
        } else {
    ...
    protected void onFinishInflate() {
        ...
        this.a = (TextView) findViewById(g.snackbar_text);
        this.b = (Button) findViewById(g.snackbar_action);
    }
