...
public class j implements Interpolator {
    ...
    public j(Context context, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        this(context.getResources(), context.getTheme(), attributeSet, xmlPullParser);
    }

    public j(Resources resources, Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray a = f.a(resources, theme, attributeSet, a.l);
        a(a, xmlPullParser);
        a.recycle();
    }
    ...
    private void a(TypedArray typedArray, XmlPullParser xmlPullParser) {
        if (f.a(xmlPullParser, "pathData")) {
            String a = f.a(typedArray, xmlPullParser, "pathData", 4);
            Path a2 = b.a(a);
            if (a2 == null) {
                throw new InflateException("The path is null, which is created from " + a);
            }
            a(a2);
        } else if (!f.a(xmlPullParser, "controlX1")) {
            throw new InflateException("pathInterpolator requires the controlX1 attribute");
        } else if (f.a(xmlPullParser, "controlY1")) {
            float a3 = f.a(typedArray, xmlPullParser, "controlX1", 0, 0.0f);
            float a4 = f.a(typedArray, xmlPullParser, "controlY1", 1, 0.0f);
            boolean a5 = f.a(xmlPullParser, "controlX2");
            if (a5 != f.a(xmlPullParser, "controlY2")) {
                throw new InflateException("pathInterpolator requires both controlX2 and controlY2 for cubic Beziers.");
            } else if (a5) {
                a(a3, a4, f.a(typedArray, xmlPullParser, "controlX2", 2, 0.0f), f.a(typedArray, xmlPullParser, "controlY2", 3, 0.0f));
            } else {
                a(a3, a4);
            }
        } else {
