        ...
        if (collection != null) {
            for (NamedType namedType : collection) {
                ...
                if (namedType.hasName()) {
                    ...
                    String name2 = _defaultTypeId(type);
                }
                if (z) {
                    hashMap.put(type.getName(), name2);
                }
                if (z2) {
                    JavaType javaType2 = (JavaType) hashMap2.get(name2);
                    if (javaType2 == null || !type.isAssignableFrom(javaType2.getRawClass())) {
                        hashMap2.put(name2, mapperConfig.constructType(type));
                    }
                }
            }
        }
