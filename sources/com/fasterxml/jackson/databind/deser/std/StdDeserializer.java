...
public abstract class StdDeserializer<T> extends JsonDeserializer<T> implements Serializable {
     ...
     */
    protected T _deserializeFromEmpty(com.fasterxml.jackson.core.JsonParser r4, com.fasterxml.jackson.databind.DeserializationContext r5) {
        /*
        r3 = this;
        r2 = 0;
        ...
        if (currentToken == JsonToken.VALUE_STRING) {
            ...
            try {
                ...
                if (length <= 9) {
                    ...
                    throw deserializationContext.weirdStringException(trim, this._valueClass, "Overflow: numeric value (" + trim + ") out of range of int (" + Integer.MIN_VALUE + " - " + MoPubClientPositioning.NO_REPEAT + ")");
                }
            } catch (IllegalArgumentException e) {
            ...
            case 6:
                ...
                try {
                    ...
                    if (length <= 9) {
                        ...
                        throw deserializationContext.weirdStringException(trim, this._valueClass, "Overflow: numeric value (" + trim + ") out of range of Integer (" + Integer.MIN_VALUE + " - " + MoPubClientPositioning.NO_REPEAT + ")");
                    }
                } catch (IllegalArgumentException e) {
