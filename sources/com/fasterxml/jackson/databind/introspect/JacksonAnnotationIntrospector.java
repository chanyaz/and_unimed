...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector implements Serializable {
    ...
    protected TypeResolverBuilder<?> _findTypeResolver(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) {
        ...
        if (jsonTypeResolver != null) {
            ...
            Object typeResolverBuilderInstance2 = _constructStdTypeResolverBuilder();
        }
        ...
        typeResolverBuilderInstance2 = typeResolverBuilderInstance2.init(jsonTypeInfo.use(), typeIdResolver);
        As include = jsonTypeInfo.include();
        if (include == As.EXTERNAL_PROPERTY && (annotated instanceof AnnotatedClass)) {
            include = As.PROPERTY;
        }
        TypeResolverBuilder typeProperty = typeResolverBuilderInstance2.inclusion(include).typeProperty(jsonTypeInfo.property());
