...
public class POJOPropertyBuilder extends BeanPropertyDefinition implements Comparable<POJOPropertyBuilder> {
    ...
    public class MemberIterator<T extends AnnotatedMember> implements Iterator<T> {
    ...
    private <T extends AnnotatedMember> Linked<T> _applyAnnotations(Linked<T> linked, AnnotationMap annotationMap) {
        Linked linked2;
        AnnotatedMember annotatedMember = (AnnotatedMember) ((AnnotatedMember) linked2.value).withAnnotations(annotationMap);
        if (linked2.next != null) {
            linked2 = linked2.withNext(_applyAnnotations(linked2.next, annotationMap));
        }
    ...
    public AnnotatedMethod getGetter() {
        ...
        while (linked2 != null) {
            ...
            if (_getterPriority != _getterPriority2) {
                linked3 = _getterPriority < _getterPriority2 ? linked2 : linked;
                linked2 = linked2.next;
                linked = linked3;
            } else {
    ...
    public AnnotatedMethod getSetter() {
        ...
        while (linked2 != null) {
            ...
            if (_setterPriority != _setterPriority2) {
                linked3 = _setterPriority < _setterPriority2 ? linked2 : linked;
            } else {
                if (this._annotationIntrospector != null) {
