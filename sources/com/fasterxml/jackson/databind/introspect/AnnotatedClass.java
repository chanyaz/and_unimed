...
public final class AnnotatedClass extends Annotated implements TypeResolutionContext {
    ...
    protected AnnotatedConstructor _constructNonDefaultConstructor(Ctor ctor, TypeResolutionContext typeResolutionContext) {
        ...
        if (paramCount != parameterAnnotations.length) {
            Object parameterAnnotations2;
            annotationMapArr = null;
            Class declaringClass = ctor.getDeclaringClass();
            Object obj;
            Object obj2;
            if (declaringClass.isEnum() && paramCount == parameterAnnotations2.length + 2) {
                obj = new Annotation[(parameterAnnotations2.length + 2)][];
                System.arraycopy(parameterAnnotations2, 0, obj, 2, parameterAnnotations2.length);
                obj2 = obj;
                annotationMapArr = _collectRelevantAnnotations((Annotation[][]) obj);
                parameterAnnotations2 = obj2;
            } else if (declaringClass.isMemberClass() && paramCount == parameterAnnotations2.length + 1) {
                obj = new Annotation[(parameterAnnotations2.length + 1)][];
                System.arraycopy(parameterAnnotations2, 0, obj, 1, parameterAnnotations2.length);
                obj2 = obj;
                annotationMapArr = _collectRelevantAnnotations((Annotation[][]) obj);
                parameterAnnotations2 = obj2;
            }
            if (annotationMapArr == null) {
                throw new IllegalStateException("Internal error: constructor for " + ctor.getDeclaringClass().getName() + " has mismatch: " + paramCount + " parameters; " + parameterAnnotations2.length + " sets of annotations");
            }
        }
        annotationMapArr = _collectRelevantAnnotations(parameterAnnotations2);
    ...
    public boolean equals(Object obj) {
        return obj == this ? true : (obj == null || obj.getClass() != getClass()) ? false : ((AnnotatedClass) obj)._class == this._class;
    }
