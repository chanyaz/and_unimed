...
public class BasicClassIntrospector extends ClassIntrospector implements Serializable {
    ...
    protected boolean _isStdJDKCollection(JavaType javaType) {
        ...
        return packageName != null ? (packageName.startsWith("java.lang") || packageName.startsWith("java.util")) ? Collection.class.isAssignableFrom(rawClass) || Map.class.isAssignableFrom(rawClass) : false : false;
    }
