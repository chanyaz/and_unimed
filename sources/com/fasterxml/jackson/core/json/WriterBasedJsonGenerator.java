...
public final class WriterBasedJsonGenerator extends JsonGeneratorImpl {
    ...
    private void _appendCharacterEscape(char c, int i) {
        ...
        if (i >= 0) {
            ...
            i4 = i3 + 1;
            cArr2[i3] = HEX_CHARS[c2 >> 4];
            i3 = i4 + 1;
            cArr2[i4] = HEX_CHARS[c2 & 15];
            this._outputTail = i3;
        } else {
            String value;
    ...
    private int _prependOrWriteCharacterEscape(char[] cArr, int i, int i2, char c, int i3) {
        ...
        if (i3 >= 0) {
            ...
            if (c > 255) {
                length = (c >> 8) & 255;
                i4 = c & 255;
                cArr2[10] = HEX_CHARS[length >> 4];
                cArr2[11] = HEX_CHARS[length & 15];
                cArr2[12] = HEX_CHARS[i4 >> 4];
                cArr2[13] = HEX_CHARS[i4 & 15];
            ...
            if (c2 > 255) {
                length = (c2 >> 8) & 255;
                i4 = i5 + 1;
                cArr[i5] = HEX_CHARS[length >> 4];
                i5 = i4 + 1;
                cArr[i4] = HEX_CHARS[length & 15];
                c2 = (char) (c2 & 255);
            } else {
                length = i5 + 1;
                cArr[i5] = '0';
            ...
            length = i5 + 1;
            cArr[i5] = HEX_CHARS[c2 >> 4];
            cArr[length] = HEX_CHARS[c2 & 15];
            return length - 5;
        }
    }
    ...
    private void _prependOrWriteCharacterEscape(char c, int i) {
        ...
        if (i >= 0) {
            ...
            if (this._outputTail >= length) {
                i3 = this._outputTail - length;
                this._outputHead = i3;
                value.getChars(0, length, this._outputBuffer, i3);
                return;
            }
            this._outputHead = this._outputTail;
            this._writer.write(value);
            ...
            i2++;
            cArr2[i2] = HEX_CHARS[c2 >> 4];
            cArr2[i2 + 1] = HEX_CHARS[c2 & 15];
        } else {
            cArr = this._entityBuffer;
            if (cArr == null) {
                cArr = _allocateEntityBuffer();
            ...
            if (c2 > 255) {
                length = (c2 >> 8) & 255;
                i3 = c2 & 255;
                cArr[10] = HEX_CHARS[length >> 4];
                cArr[11] = HEX_CHARS[length & 15];
                cArr[12] = HEX_CHARS[i3 >> 4];
                cArr[13] = HEX_CHARS[i3 & 15];
                this._writer.write(cArr, 8, 6);
                return;
            }
            cArr[6] = HEX_CHARS[c2 >> 4];
            cArr[7] = HEX_CHARS[c2 & 15];
    ...
    protected void _verifyPrettyValueWrite(String str) {
    ...
    protected int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr) {
        int i;
        int i2;
        int i3 = -3;
    ...
    protected int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr, int i) {
        int i2;
        int i3 = 0;
        int i4 = 0;
        int i5 = -3;
    ...
    protected void _writeFieldName(SerializableString serializableString, boolean z) {
        if (this._cfgPrettyPrinter != null) {
    ...
    protected void _writePPFieldName(SerializableString serializableString, boolean z) {
        if (z) {
    ...
    protected void _writePPFieldName(String str, boolean z) {
        if (z) {
            this._cfgPrettyPrinter.writeObjectEntrySeparator(this);
        } else {
            this._cfgPrettyPrinter.beforeObjectEntries(this);
