...
public final class a {
    ...
    @VisibleForTesting
    static final int[] c = new int[]{3, 31, 316, 3162, 31622, 316227, 3162277, 31622776, 316227766, MoPubClientPositioning.NO_REPEAT};
    @VisibleForTesting
    static int[] d = new int[]{MoPubClientPositioning.NO_REPEAT, MoPubClientPositioning.NO_REPEAT, 65536, 2345, 477, 193, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};
    ...
    /* JADX WARNING: Missing block: B:32:0x0060, code:
            if ((((r2 & 1) != 0 ? 1 : 0) & (r9 == java.math.RoundingMode.HALF_EVEN ? 1 : 0)) != 0) goto L_0x0062;
     */
    public static int a(int r7, int r8, java.math.RoundingMode r9) {
        /*
        r0 = 1;
        r1 = 0;
        com.google.common.base.s.a(r9);
    ...
    L_0x0018:
        ...
        r4 = r4 >> 31;
        r5 = r4 | 1;
        r4 = com.google.common.math.a.AnonymousClass1.a;
        r6 = r9.ordinal();
        r4 = r4[r6];
        switch(r4) {
    ...
    L_0x006d:
        ...
        goto L_0x0039;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.a.a(int, int, java.math.RoundingMode):int");
    }
