...
public class GetServiceRequest extends AbstractSafeParcelable {
    public static final Creator<GetServiceRequest> CREATOR = new t();
    @VersionField(id = 1)
    private final int a;
    @Field(id = 2)
    private final int b;
    ...
    private static Account a(IBinder iBinder) {
        return iBinder != null ? a.a(aa.a(iBinder)) : null;
    }
    ...
    public GetServiceRequest a(IAccountAccessor iAccountAccessor) {
        if (iAccountAccessor != null) {
            this.e = iAccountAccessor.asBinder();
        }
        return this;
    }
