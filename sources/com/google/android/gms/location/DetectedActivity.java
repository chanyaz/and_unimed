...
public class DetectedActivity extends AbstractSafeParcelable {
    public static final Creator<DetectedActivity> CREATOR = new aa();
    private static final Comparator<DetectedActivity> a = new z();
    ...
    public int hashCode() {
        return ap.a(Integer.valueOf(this.e), Integer.valueOf(this.f));
    }
