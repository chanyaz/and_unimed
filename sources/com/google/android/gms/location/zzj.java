...
public final class zzj extends AbstractSafeParcelable {
    public static final Creator<zzj> CREATOR = new ab();
    ...
    public final int hashCode() {
        return ap.a(Boolean.valueOf(this.a), Long.valueOf(this.b), Float.valueOf(this.c), Long.valueOf(this.d), Integer.valueOf(this.e));
    }
    ...
    public final String toString() {
        ...
        if (this.e != MoPubClientPositioning.NO_REPEAT) {
