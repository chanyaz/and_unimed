...
public interface FusedLocationProviderApi {
    ...
    PendingResult<Status> removeLocationUpdates(GoogleApiClient googleApiClient, d dVar);
    ...
    @RequiresPermission(anyOf = {"android.permission.ACCESS_COARSE_LOCATION", "android.permission.ACCESS_FINE_LOCATION"})
    PendingResult<Status> requestLocationUpdates(GoogleApiClient googleApiClient, LocationRequest locationRequest, d dVar, Looper looper);
