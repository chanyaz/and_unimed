...
public final class LocationRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    public static final Creator<LocationRequest> CREATOR = new k();
    ...
    public LocationRequest() {
        ...
        this.f = MoPubClientPositioning.NO_REPEAT;
        this.g = 0.0f;
        this.h = 0;
    }
    ...
    public final int hashCode() {
        return ap.a(Integer.valueOf(this.a), Long.valueOf(this.b), Float.valueOf(this.g), Long.valueOf(this.h));
    }
    ...
    public final String toString() {
        ...
        if (this.f != MoPubClientPositioning.NO_REPEAT) {
