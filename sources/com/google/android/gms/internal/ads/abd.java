...
public final class abd {
    ...
    private abd(ByteBuffer byteBuffer) {
        this.a = byteBuffer;
        this.a.order(ByteOrder.LITTLE_ENDIAN);
    }

    private abd(byte[] bArr, int i, int i2) {
    ...
    L_0x0094:
        ...
        goto L_0x0015;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.abd.a(java.lang.CharSequence):int");
    }
    ...
    public static abd a(byte[] bArr) {
        return a(bArr, 0, bArr.length);
    }

    public static abd a(byte[] bArr, int i, int i2) {
        return new abd(bArr, 0, i2);
    }
    ...
    public static int b(int i, abj abj) {
        int b = b(i);
        int d = abj.d();
        return b + (d + d(d));
    }
    ...
    public final void a(int i, abj abj) {
        c(i, 2);
        if (abj.Z < 0) {
            abj.d();
        }
        ...
        try {
            ...
            if (d == d(str.length() * 3)) {
                ...
                if (this.a.remaining() < d) {
                    throw new zzbfb(d + position, this.a.limit());
                }
