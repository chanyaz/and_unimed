...
final class wa {
    ...
    static byte[] a(byte[] bArr, byte[] bArr2) {
        ...
        for (int i = 0; i < bArr2.length; i += 16) {
            ...
            j3 += a(bArr3, 6, 4);
            j4 += a(bArr3, 9, 6);
            j5 += a(bArr3, 12, 8) | ((long) (bArr3[16] << 24));
            long j10 = ((((j * a) + (j2 * j9)) + (j3 * j8)) + (j4 * j7)) + (j5 * j6);
            long j11 = ((((j * a2) + (j2 * a)) + (j3 * j9)) + (j4 * j8)) + (j5 * j7);
            long j12 = ((((j * a3) + (j2 * a2)) + (j3 * a)) + (j4 * j9)) + (j5 * j8);
            j3 *= a3;
            j4 *= a2;
            j5 *= a;
            j5 += j4 + (j3 + ((j2 * a4) + (j * a5)));
            ...
            j4 = j12 + (j4 >> 26);
            j3 = 67108863 & j4;
            j4 = (((((j * a4) + (j2 * a3)) + (j3 * a2)) + (j4 * a)) + (j5 * j9)) + (j4 >> 26);
            j = j4 >> 26;
            j4 &= 67108863;
            j5 += j;
            j = j5 >> 26;
        ...
        j13 |= (a2 & 67108863) & a5;
        j4 |= (a3 & 67108863) & a5;
        j3 = ((j3 | ((j & 67108863) & a5)) | (j2 << 26)) & 4294967295L;
        j2 = ((j2 >> 6) | (j13 << 20)) & 4294967295L;
        j13 = ((j13 >> 12) | (j4 << 14)) & 4294967295L;
        j5 = (((j5 | (a4 & a5)) << 8) | (j4 >> 18)) & 4294967295L;
        j4 = a(bArr, 16) + j3;
        j3 = 4294967295L & j4;
        j4 = (j4 >> 32) + (j2 + a(bArr, 20));
        j2 = 4294967295L & j4;
        j13 = (j13 + a(bArr, 24)) + (j4 >> 32);
        j4 = 4294967295L & j13;
        j13 = ((j13 >> 32) + (j5 + a(bArr, 28))) & 4294967295L;
