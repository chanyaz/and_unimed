...
public final class zzm extends AbstractSafeParcelable {
    public static final Creator<zzm> CREATOR = new ap();
    @VisibleForTesting
    ...
    public final boolean equals(Object obj) {
        ...
        zzm zzm = (zzm) obj;
        return ap.a(this.c, zzm.c) && ap.a(this.d, zzm.d) && ap.a(this.e, zzm.e);
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        int a = a.a(parcel);
        a.a(parcel, 1, this.c, i, false);
        a.c(parcel, 2, this.d, false);
