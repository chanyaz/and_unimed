...
public class JsonReader implements Closeable {
    ...
    private final char[] buffer = new char[c.jk];
    ...
    private String nextUnquotedValue() {
        ...
        String str = stringBuilder == null ? new String(this.buffer, this.pos, i) : stringBuilder.append(this.buffer, this.pos, i).toString();
        this.pos = i + this.pos;
        return str;
    }
    ...
    private int peekNumber() {
        ...
        if (i3 == 2 && i2 != 0 && ((j != Long.MIN_VALUE || obj != null) && (j != 0 || obj == null))) {
            if (obj == null) {
                j = -j;
            }
            this.peekedLong = j;
