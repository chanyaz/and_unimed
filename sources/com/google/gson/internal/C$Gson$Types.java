...
public final class C$Gson$Types {
    ...
    private static Type resolve(Type type, Class<?> cls, Type type2, Collection<TypeVariable> collection) {
        ...
        if ((type4 instanceof Class) && ((Class) type4).isArray()) {
            ...
            type3 = cls2.getComponentType();
            resolve = C$Gson$Types.resolve(type, cls, type3, collection);
            return type3 != resolve ? C$Gson$Types.arrayOf(resolve) : cls2;
            ...
            resolve = C$Gson$Types.resolve(type, cls, type3, collection);
            return type3 != resolve ? C$Gson$Types.arrayOf(resolve) : genericArrayType;
            ...
            int i = resolve2 != type3 ? 1 : 0;
            actualTypeArguments = parameterizedType.getActualTypeArguments();
            int length = actualTypeArguments.length;
            int i2 = i;
            typeArr = actualTypeArguments;
            for (int i3 = 0; i3 < length; i3++) {
                Type resolve3 = C$Gson$Types.resolve(type, cls, typeArr[i3], collection);
                if (resolve3 != typeArr[i3]) {
                    if (i2 == 0) {
            ...
            return i2 != 0 ? C$Gson$Types.newParameterizedTypeWithOwner(resolve2, parameterizedType.getRawType(), typeArr) : parameterizedType;
            ...
            if (typeArr.length == 1) {
                resolve = C$Gson$Types.resolve(type, cls, typeArr[0], collection);
