...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private Map<String, BoundField> getBoundFields(Gson gson, TypeToken<?> typeToken, Class<?> cls) {
        ...
        while (cls2 != Object.class) {
            for (AccessibleObject accessibleObject : cls2.getDeclaredFields()) {
                boolean excludeField = excludeField(accessibleObject, true);
                boolean excludeField2 = excludeField(accessibleObject, false);
                if (excludeField || excludeField2) {
                    this.accessor.makeAccessible(accessibleObject);
                    Type resolve = C$Gson$Types.resolve(typeToken.getType(), cls2, accessibleObject.getGenericType());
                    List fieldNames = getFieldNames(accessibleObject);
                    ...
                    while (i < size) {
                        ...
                        BoundField boundField2 = (BoundField) linkedHashMap.put(str, createBoundField(gson, accessibleObject, str, TypeToken.get(resolve), excludeField, excludeField2));
                        if (boundField != null) {
